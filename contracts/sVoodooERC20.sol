...
contract sVoodoo is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Voodoo", "sVODO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sVODO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sVODO
