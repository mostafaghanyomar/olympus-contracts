...
describe('Voodoo Staking', () => {
    ...
    beforeEach(async () => {
        ...
        OLY = await ethers.getContractFactory('VoodooERC20TOken');
        oly = await OLY.deploy();

        Staking = await ethers.getContractFactory('VoodooStaking');
        ...
        sOLY = await ethers.getContractFactory('sVoodoo');
