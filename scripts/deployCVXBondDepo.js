...
async function main() {
    ...
    const VODO = "0x383518188c0c6d7730d91b2c03a03c837814a899";
    ...
    const CVXBond = await ethers.getContractFactory('VoodooCVXBondDepository');

    // Deploy CVX bond
    const cvxBond = await CVXBond.deploy(VODO, CVX, Treasury, DAO);
